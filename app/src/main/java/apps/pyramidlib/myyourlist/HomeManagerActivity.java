...
public class HomeManagerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(respondProject.optInt("status", 0) == 1){
                ...
                projectManagerAdapter = new ProjectManagerAdapter(this, projectList);
                listView.setAdapter(projectManagerAdapter);

                listView.setOnItemClickListener(projectManagerAdapter);
            }
    ...
    private class GetProjectAction extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            String respondBack = "";
            try {
                String respond= sHandler.makeServiceCall(Constants.URL_SERVER+"/api/project/get_project_by_pic?key=" + Constants.User.USER_KEY,ServiceHandler.GET);
